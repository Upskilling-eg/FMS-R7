...
export default function CategoriesList() {
  ...
  const getAllCategories =async () =>{
    try {
     let response =await axios.get('https://upskilling-egypt.com:3006/api/v1/Category/?pageSize=3&pageNumber=1',
     {headers:{
  ...
  return (
    <>
     ...
     <Header imgPath={headerImg} title={'Categories Items'} description={'You can now add your items that any user can order it from the Application and you can edit'}/>
      ...
      <Modal show={showAdd} onHide={handleCloseAdd}>
        ...
        <Modal.Body>
             ...
             <div className="input-group mb-3">
                    ...
                    })} type="text" className="form-control" placeholder="Category name" aria-label="Username" aria-describedby="basic-addon1"/>
                  </div>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <i className="fa fa-edit mx-2 text-warning" aria-hidden="true"></i>
              <i onClick={()=>handleShow(item.id)} className="fa fa-trash text-danger" aria-hidden="true"></i>
            </td>
